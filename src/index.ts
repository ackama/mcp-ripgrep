...
import { CallToolRequestSchema, ListRootsResultSchema, ListToolsRequestSchema } from "@modelcontextprotocol/sdk/types.js";
...
const server = new Server(
  ...
  },
  {
    capabilities: {
      ...
      roots: {  // Declare that we want to access roots
        listChanged: true,
      },
    }
  }
...
async function getRoots() {
  try {
    ...
    const response = await server.request<typeof ListRootsResultSchema>(
      { method: "roots/list" },
